...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getProjectControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\ProjectController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('H4jTfYHHgL', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ProjectsRepository' => ['privates', 'App\\Repository\\ProjectsRepository', 'getProjectsRepositoryService', false],
    ...
    protected function getProfilerService()
    {
        ...
        $f = \Symfony\Component\HttpClient\HttpClient::create([], 6);
        $f->setLogger($a);

        $e->registerClient('http_client', new \Symfony\Component\HttpClient\TraceableHttpClient($f));
    ...
    /**
     * Gets the private '.service_locator.YNTENy2' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_YNTENy2Service()
    {
        return $this->privates['.service_locator.YNTENy2'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ProjectController::delete' => ['privates', '.service_locator._CDY2gJ', 'get_ServiceLocator_CDY2gJService', false],
            'App\\Controller\\ProjectController::edit' => ['privates', '.service_locator._CDY2gJ', 'get_ServiceLocator_CDY2gJService', false],
            'App\\Controller\\ProjectController::new' => ['privates', '.service_locator._CDY2gJ', 'get_ServiceLocator_CDY2gJService', false],
     ...
     */
    protected function getProjectFormTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\ProjectFormType.php';

        return $this->privates['App\\Form\\ProjectFormType'] = new \App\Form\ProjectFormType();
    }
     ...
     */
    protected function getProjectsRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\ProjectsRepository'] = new \App\Repository\ProjectsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getLoginFormAuthenticatorService()
    {
        ...
        return $this->privates['App\\Security\\LoginFormAuthenticator'] = new \App\Security\LoginFormAuthenticator(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wqWgGZlmKR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QGhHu7UOUT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kYFz2ZFfMd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xoFDtwITjW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wsL0NH9IMo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.YNTENy2'] ?? $this->get_ServiceLocator_YNTENy2Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\ProjectFormType' => ['privates', 'App\\Form\\ProjectFormType', 'getProjectFormTypeService', false],
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.user'] ?? $this->getSecurity_User_Provider_Concrete_UserService());
    ...
    protected function getSecurity_User_Provider_Concrete_UserService()
    {
        ...
        return $this->privates['security.user.provider.concrete.user'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', '', NULL);
    }
